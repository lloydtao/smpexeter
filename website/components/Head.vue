  ...
  <section class="py-20 md:py-40">
    <div class="container mx-auto px-8 lg:flex">
      <div class="text-center lg:text-left lg:w-1/2">
        <h1
          class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none text-gray-200"
        >
        ...
        <div class="py-3">
          ...
          <a href="https://discord.gg/W6WsBZAAqZ">
            <button
              type="button"
              class="py-3 px-5 bg-discord hover:bg-indigo-600 rounded text-white"
            >
              <div class="flex items-center text-white">
                <svg
                  viewBox="0 0 24 24"
